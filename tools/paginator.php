...
class Paginator {
     ...
     * @return void
     */
    protected function __construct($uri, $page, $total, $per_page, $last)
    {
        $this->uri = $uri;
        $this->page = $page;
        $this->last = $last;
     ...
     * @return Paginator
     */
    public static function make($uri, $total, $per_page)
    {
        $page = static::page($total, $per_page);

        $last = ceil($total / $per_page);

        return new static($uri, $page, $total, $per_page, $last);
    }
    ...
    public function links($adjacent = 3)
    {
        ...
        $content = '<ul>' . $this->previous('&laquo;') . $links . $this->next('&raquo;') . '</ul>';
    ...
    protected function element($element, $page, $text, $disabled)
    {
        ...
        {
            $attributes = " class=\"{$class} disabled\"";
    ...
    protected function link($page, $text, $class)
    {
        ...
        return '<li'.$attributes.'><a href="'. $this->uri.$query .'">'. $text .'</a></li>';
    }
